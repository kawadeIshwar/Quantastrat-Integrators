  ...
  return (
    <section className="relative isolate flex min-h-[50svh] items-center overflow-hidden bg-hero-gradient pt-32">
      ...
      <div className="container-x relative z-10 pb-12">
        ...
        <h1 className="heading-xl font-bold text-brand-ink !text-3xl md:!text-5xl lg:!text-[56px]">{title}</h1>
        {description && (
          <p className="mt-7 text-lg text-gray-600 leading-relaxed md:text-xl">{description}</p>
        )}
      </div>
    </section>
  );
